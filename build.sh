...
if [ "$(uname -s)" = "Darwin" ]; then
    ...
    echo "Docs:   dist/README.txt  dist/GETTING_STARTED.txt  dist/USER_MANUAL.pdf"
    echo ""
    echo "To run:  open 'dist/Hayseys Astrostacker.app'"
    echo "To distribute: zip the .app, README.txt, GETTING_STARTED.txt and USER_MANUAL.pdf together"
    ...
    echo "Docs:   dist/Hayseys Astrostacker/README.txt  GETTING_STARTED.txt  USER_MANUAL.pdf"
    echo ""
